"""Single-user local demo API. No supplier send endpoint exists."""
...
def dataset_summary():
    ...
    return dict(
        ...
        sources={
            ...
            for name in ["sales", "inventory", "stockouts", "inbound", "materials", "suppliers"]
        },
    )
